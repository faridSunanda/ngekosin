...
<div>
    ...
    <div class="space-y-1">
        <a href="{{ route('user.profile') }}" 
           class="flex items-center justify-between px-3 py-2.5 rounded-md font-medium text-xs transition {{ request()->routeIs('user.profile') ? 'bg-[#f99d18] text-white shadow-md' : 'text-slate-300 hover:bg-[#20344c] hover:text-white' }}">
            <div class="flex items-center gap-3">
